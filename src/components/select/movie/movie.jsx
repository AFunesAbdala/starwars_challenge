...
function MovieComponent(props) {
    ...
    return (
        <Link href={`/select/movies/${urlId}`} key={key}>
            ...
            <div className="relative w-80 hover:shadow-lg hover:shadow-redTwo hover:scale-105 duration-300" onMouseEnter={() => handleHoverBar(true)} onMouseLeave={() => handleHoverBar(false)}>
                <div className="absolute w-full bottom-0 z-30 text-white flex flex-row justify-between items-end px-5 py-3 bg-gradient-to-t from-red-700">
